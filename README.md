...
- Limitations or issues
  Without using playwright MCP tools, the LLM likely won't generate working tests. Apart from that, I didn't really have any issues with the LLM part apart dealing with tokens and context windows. In terms of manual, I just found it tedious to write the tests, but I imagine the process gets smoother the more you do it.
